...
/*   Updated: 2024/01/23 13:37:37 by fcandia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ftpf_print_u(t_ftpf_fmt *format, va_list args, int *counter);
void			ftpf_print_x(t_ftpf_fmt *format, va_list args, int *counter);
void			ftpf_print_x_uc(t_ftpf_fmt *format, va_list args, int *counter);
#endif
